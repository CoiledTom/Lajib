-- CoiledTom Hub | Icon Browser GUI
-- Exibe todos os ícones Lucide disponíveis com busca e cópia de nome
...
local Icons = {
	...
	["lucide-hop"] = "rbxassetid://10723414219",
	["lucide-hop-off"] = "rbxassetid://10723414052",
	["lucide-hourglass"] = "rbxassetid://10723414398",
	["lucide-ice-cream"] = "rbxassetid://10723414504",
	["lucide-image"] = "rbxassetid://10723415031",
	["lucide-image-minus"] = "rbxassetid://10723414678",
	["lucide-image-off"] = "rbxassetid://10723414814",
	["lucide-image-plus"] = "rbxassetid://10723414905",
	["lucide-import"] = "rbxassetid://10723415130",
	["lucide-inbox"] = "rbxassetid://10723415228",
	["lucide-indent"] = "rbxassetid://10723415330",
	["lucide-info"] = "rbxassetid://10723415427",
	["lucide-inspect"] = "rbxassetid://10723415539",
	["lucide-italic"] = "rbxassetid://10723415631",
	["lucide-japanese-yen"] = "rbxassetid://10723415735",
	["lucide-joystick"] = "rbxassetid://10723415876",
	["lucide-key"] = "rbxassetid://10723423685",
	["lucide-keyboard"] = "rbxassetid://10723415976",
	["lucide-lamp"] = "rbxassetid://10723424277",
	["lucide-lamp-ceiling"] = "rbxassetid://10723424012",
	["lucide-lamp-desk"] = "rbxassetid://10723424134",
	["lucide-lamp-floor"] = "rbxassetid://10723424160",
	["lucide-lamp-wall-down"] = "rbxassetid://10723424192",
	["lucide-lamp-wall-up"] = "rbxassetid://10723424243",
	["lucide-laptop"] = "rbxassetid://10723424520",
	["lucide-laptop-2"] = "rbxassetid://10723424399",
	["lucide-lasso"] = "rbxassetid://10723424693",
	["lucide-lasso-select"] = "rbxassetid://10723424604",
	["lucide-layers"] = "rbxassetid://10723424811",
	["lucide-layout"] = "rbxassetid://10723425048",
	["lucide-layout-dashboard"] = "rbxassetid://10723424914",
	["lucide-layout-grid"] = "rbxassetid://10723425118",
...
TitleLabel.Text = "🎨  Icon Browser  —  " .. #sortedNames .. " ícones"
...
Sep.BackgroundColor3 = Color3.fromRGB(80, 60, 160)
...
SearchFrame.BackgroundColor3 = Color3.fromRGB(22, 18, 42)
...
SearchIcon.TextColor3 = Color3.fromRGB(140, 120, 200)
...
SearchBox.PlaceholderText = "Buscar ícone..."
SearchBox.PlaceholderColor3 = Color3.fromRGB(90, 80, 130)
SearchBox.Text = ""
...
CountLabel.Text = #sortedNames .. " ícones encontrados"
CountLabel.TextColor3 = Color3.fromRGB(110, 100, 160)
CountLabel.TextSize = 11
CountLabel.Font = Enum.Font.Gotham
CountLabel.TextXAlignment = Enum.TextXAlignment.Left
CountLabel.Parent = Main

-- Área de scroll dos ícones
local ScrollFrame = Instance.new("ScrollingFrame")
ScrollFrame.Name = "IconGrid"
ScrollFrame.Size = UDim2.new(1, -20, 1, -116)
...
GridLayout.CellSize = UDim2.new(0, 82, 0, 90)
...
-- Tooltip de nome copiado
local Tooltip = Instance.new("Frame")
Tooltip.Size = UDim2.new(0, 240, 0, 28)
Tooltip.Position = UDim2.new(0.5, -120, 1, -40)
Tooltip.BackgroundColor3 = Color3.fromRGB(60, 200, 100)
...
local function showTooltip(name)
	TooltipText.Text = "✓  \"" .. name .. "\""
	if tooltipTween then tooltipTween:Cancel() end
	Tooltip.BackgroundTransparency = 0
	TooltipText.TextTransparency = 0
	tooltipTween = TweenService:Create(Tooltip, TweenInfo.new(1.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		BackgroundTransparency = 1
	})
	TweenService:Create(TooltipText, TweenInfo.new(1.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		TextTransparency = 1
	}):Play()
	tooltipTween:Play()
end
...
-- ============================================================
-- CRIAR CARDS DE ÍCONES
-- ============================================================

local iconCards = {}

local function createCard(name, asset, order)
	...
	cardStroke.Color = Color3.fromRGB(70, 55, 130)
	...
	img.Image = asset
	img.ImageColor3 = Color3.fromRGB(180, 160, 255)
	img.ScaleType = Enum.ScaleType.Fit
	img.Parent = card

	-- Nome do ícone (sem prefixo lucide-)
	local shortName = name:gsub("^lucide%-", "")
	local lbl = Instance.new("TextLabel")
	lbl.Size = UDim2.new(1, -6, 0, 30)
	lbl.Position = UDim2.new(0, 3, 0, 50)
	...
	card.MouseEnter:Connect(function()
		TweenService:Create(card, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(35, 28, 65)}):Play()
		TweenService:Create(cardStroke, TweenInfo.new(0.15), {Transparency = 0, Color = Color3.fromRGB(130, 100, 240)}):Play()
		TweenService:Create(img, TweenInfo.new(0.15), {ImageColor3 = Color3.fromRGB(220, 200, 255)}):Play()
	end)
	card.MouseLeave:Connect(function()
		TweenService:Create(card, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(20, 16, 36)}):Play()
		TweenService:Create(cardStroke, TweenInfo.new(0.15), {Transparency = 0.6, Color = Color3.fromRGB(70, 55, 130)}):Play()
		TweenService:Create(img, TweenInfo.new(0.15), {ImageColor3 = Color3.fromRGB(180, 160, 255)}):Play()
	end)

	-- Clique: copia o nome para clipboard
	card.MouseButton1Click:Connect(function()
		...
		showTooltip(name)
		-- Flash no card
		TweenService:Create(card, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(60, 200, 100)}):Play()
		task.delay(0.15, function()
			TweenService:Create(card, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(20, 16, 36)}):Play()
		end)
	end)
...
for i, name in ipairs(sortedNames) do
	local card = createCard(name, Icons[name], i)
	iconCards[name] = card
end
